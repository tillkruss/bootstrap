...
{% example html %}
<div class="d-flex flex-nowrap bd-highlight">
  <div class="flex-order-last p-2 bd-highlight">First flex item</div>
  <div class="p-2 bd-highlight">Second flex item</div>
  <div class="flex-order-first p-2 bd-highlight">Third flex item</div>
</div>
{% endexample %}
...
{% for bp in site.data.breakpoints %}
- `.flex-order{{ bp.abbr }}-first`
- `.flex-order{{ bp.abbr }}-last`
- `.flex-order{{ bp.abbr }}-0`{% endfor %}
